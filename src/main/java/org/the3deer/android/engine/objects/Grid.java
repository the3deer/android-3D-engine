...
public class Grid {
    ...
    public static Object3D build(float xStart, float yStart, float zStart, float xEnd, float yEnd, float zEnd,
                                 float step) {
        ...
        return new Object3D(vertexBuffer).setDrawMode(GLES20.GL_LINES);
    }
}
