...
public final class Cube {
    ...
    public static Object3D buildCubeV3(byte[] textureData) {
        return new Object3D(
                IOUtils.createFloatBuffer(cubePositionData.length).put(cubePositionData),
    ...
    public static Object3D buildCubeV4(byte[] textureData) {
        return new Object3D(
                IOUtils.createFloatBuffer(cubePositionData.length).put(cubePositionData),
    ...
    public static Object3D buildCubeV2() {
        ...
        return new Object3D(vertexBuffer,drawBuffer).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV2")
