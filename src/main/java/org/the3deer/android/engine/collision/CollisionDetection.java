...
public class CollisionDetection {
    ...
    public static float[] getTriangleIntersection(Object3D hit, int width, int height, float[] viewMatrix, float[] projectionMatrix, float windowX, float windowY) {
    ...
    private static float[] getTriangleIntersection(final Object3D hit, float[] nearHit, float[] farHit) {
        ...
        // get model matrix
        float[] modelMatrix = hit.getModelMatrix();
        ...
        if (intersection != -1) {
            ...
            Matrix.multiplyMV(realIntersection, 0, modelMatrix, 0, Math3DUtils.to4d(intersectionPoint), 0);
