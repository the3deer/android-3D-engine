...
public class Node {
    ...
    private String instanceCameraId; // The ID of the camera this node instances
    ...
    public String getInstanceCameraId() {
        return instanceCameraId;
    }

    public void setInstanceCameraId(String instanceCameraId) {
        this.instanceCameraId = instanceCameraId;
    }
